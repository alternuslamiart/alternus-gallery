            ...
            <div className="border-t pt-4 space-y-4">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="flex justify-center items-center gap-4">
                  ...
                  {/* PayPal */}
                  <div className="bg-white border rounded px-3 py-1.5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="24" viewBox="0 0 256 302">
                      <path fill="#27346A" d="M217.2 23.6C206.3 10.6 186.9 5 162.6 5H68.9c-7.4 0-13.7 5.4-14.9 12.7L18.2 257.6c-.9 5.2 3.1 9.9 8.4 9.9h61.2l15.4-97.6-.5 3c1.2-7.3 7.5-12.6 14.9-12.6h31c60.8 0 108.4-24.7 122.3-96.2.4-2.1.8-4.2 1-6.2-.2-.1-.2-.1 0 0 4-26.1-.1-43.8-14.7-58.3"/>
                      <path fill="#27346A" d="M217.2 23.6C206.3 10.6 186.9 5 162.6 5H68.9c-7.4 0-13.7 5.4-14.9 12.7L18.2 257.6c-.9 5.2 3.1 9.9 8.4 9.9h61.2l15.4-97.6 16.3-103.3h61.1c42.6 0 72-14.5 82.6-56.6-4.2 2.2-8.3 4.1-12.4 5.7-5.9 2.1-12 3.7-18.3 4.8-6.4 1.1-13 1.6-19.7 1.6-4.4.1-8.9-.2-13.4-.6-.2 0-.5-.1-.7-.1-4.5-.5-9-1.2-13.4-2.2-.4-.1-.9-.2-1.3-.3-4.4-1-8.7-2.2-12.9-3.7-4.3-1.5-8.4-3.2-12.4-5.2-.4-.2-.9-.4-1.3-.7-3.9-2-7.7-4.2-11.3-6.6-.4-.2-.7-.5-1.1-.7-3.6-2.5-7-5.2-10.3-8.1-.3-.3-.7-.6-1-1-3.2-2.9-6.3-5.9-9.2-9.2z"/>
                      <path fill="#2790C3" d="M272.1 63.9c-13.9 71.5-61.5 96.2-122.3 96.2h-31c-7.4 0-13.7 5.3-14.9 12.6l-21.8 138.5c-.8 4.5 2.7 8.6 7.3 8.6h51.2c6.5 0 12-4.7 13-11.1l.5-2.7 10.3-65.2.7-3.6c1-6.4 6.5-11.1 13-11.1h8.2c53 0 94.5-21.5 106.6-83.8 5.1-26 2.5-47.8-11-63-.8-.9-1.6-1.8-2.5-2.6-2.1 3.5-4.5 6.7-7.3 9.7v-.5"/>
                      <path fill="#1F264F" d="M256 79.8c-1.9-.6-3.9-1.1-5.9-1.5-2-.4-4.1-.8-6.2-1.1-7.5-1-15.6-1.5-24.1-1.5h-73c-1.8 0-3.5.3-5.1.9-4.5 1.5-7.8 5.6-8.6 10.6l-16.3 103.3-.5 3c1.2-7.3 7.5-12.6 14.9-12.6h31c60.8 0 108.4-24.7 122.3-96.2.4-2.1.8-4.2 1-6.2-3.5-1.9-7.4-3.5-11.5-5-5.7 2.2-11.8 4-18 5.3z"/>
                    </svg>
                  </div>
                </div>
              </div>
